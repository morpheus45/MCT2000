...
export const demoEvents: DemoEvent[] = [
  {
    ...
    location: "Clermont-l'Hérault → Salagou (boucle)",
    distance_km: 60,
    level: "Facile",
    going_count: 12,
    my_status: null,
  },
  {
    ...
    location: "Départ place de la Mairie, Clermont-l'Hérault",
    distance_km: 90,
    level: "Facile",
    going_count: 18,
    my_status: "going",
  ...
  },
  {
    ...
    location: "Clermont-l'Hérault → Meyrueis",
    distance_km: 350,
    level: "Confirmé",
    going_count: 14,
    my_status: null,
  },
  {
    ...
    location: "Clermont-l'Hérault — boucle de 100 km",
    distance_km: 100,
    level: "Facile",
    going_count: 42,
    my_status: "going",
